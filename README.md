...
- [EC2 install LAMP stack](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/install-LAMP.html)

- [Install PHP and MariabDB on EC2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Tutorials.WebServerDB.CreateWebServer.html)
